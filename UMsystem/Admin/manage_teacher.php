            ...
            <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                ...
                <?php while($result=mysqli_fetch_assoc($resource_id)){ ?>
                    <tr>
                        ...
                        <td><button class="btn-danger btn"><a href="teacher-delete.php?id=<?php echo $result['id']; ?>" class="text-white">Delete</a></button></td>
                        <td><button class="btn-success btn"><a href="teacher.php?id=<?php echo $result['id']; ?>" class="text-white">Update</a></button></td>
