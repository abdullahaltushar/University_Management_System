...
if(isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `student`( `name`, `registration_number`, `program`, `academic_year`, `email`, `address`, `mobile`, `nationality`, `gender`) VALUES ('$name','$registration','$program','$years','$email','$address','$mobile','$nationality','$gender')";
